...
#while(True):
    ...
    # tag1[0]
    if (i==0):
        if (cipher[12:] == str(0x103ca96c06a1ce798f08f8ef)):
    ...
    # tag2[0]^tag1[1]
    if (i==1):
        if (cipher[12:] == str((0x103ca96c06a1ce798f08f8ef)^(0xf0dfb0ccdb567d48b285b23d))):
    ...
    if (i==2):
        if (cipher[12:] == str((0x103ca96c06a1ce798f08f8ef)^(0xf0dfb0ccdb567d48b285b23d)^(0x0cd773454667a3c2fa5f1b58))):
    ...
    if (i==3):
        if (cipher[12:] == str((0x103ca96c06a1ce798f08f8ef)^(0xf0dfb0ccdb567d48b285b23d)^(0x0cd773454667a3c2fa5f1b58)^(0xd9cdf2329bd9979730bfaaff))):
